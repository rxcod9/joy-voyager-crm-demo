                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://github.com/rxcod9/joy-voyager-crm-demo" class="underline text-gray-900 dark:text-white">Documentation</a></div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://github.com/rxcod9/joy-voyager-crm-demo/issues" class="underline text-gray-900 dark:text-white">Facing issues?</a></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Find yourself stuck using the package? Found a bug? Do you have general questions or suggestions for improving the joy voyager-datatable? Feel free to <a href="https://github.com/rxcod9/joy-voyager-crm-demo/issues">create an issue on GitHub</a>, we'll try to address it as soon as possible.
                                </div>
                            </div>
                        </div>
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-gray-500 sm:text-left">
                        <div class="flex items-center">
                            ...
                            <a target="_blank" href="https://github.com/rxcod9/joy-voyager-crm-demo" class="ml-1 underline">
                                Github
                            </a>
